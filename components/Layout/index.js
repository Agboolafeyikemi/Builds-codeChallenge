      ...
      <div className="min-h-screen m-auto">
        <main className="flex items-start justify-center">
          <div className="bg-gray-800 rounded-lg mr-10 max-w-sm w-96 mt-12 text-gray-100 p-6">
            ...
            <ul>
              <li className="flex items-center my-1">
                <pre>
                  {" "}
                  Email :{" "}
                  <code className="bg-gray-900 p-1 border border-gray-500 rounded text-sm">
                    test@test.com
                  </code>
                </pre>
              </li>
            ...
            <p>
              If everything goes well you will be presented with all your
              details at profile page.
            </p>
            <p>
              You can refresh the page at any instance it will resume on the
              same step.
            </p>
          </div>
